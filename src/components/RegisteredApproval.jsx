        ...
        <div className="container ">
            <div className="row">
                ...
                {members.map(member => (
                    ...
                    <td>
                        {member.paymentStatus==="Paid"?(<button className="btn btn-danger mx-2" onClick={()=> handleDelete(member._id)}>Delete</button>):(<button className="btn btn-info mx-2" onClick={() => handleUpdatePaymentStatus(member._id, { paymentStatus: 'Paid' })}>
                        Approve
                        </button> )}
